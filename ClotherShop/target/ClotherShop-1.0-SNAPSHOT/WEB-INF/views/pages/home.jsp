                    ...
                    <div class="col-md-3 arrival-grid simpleCart_shelfItem" style="margin-bottom: 30px">
                        <div class="grid-arr">
                            <div class="grid-arrival">
                                <figure>
                                    <a href="productDetails?id=${listProducts.getIdProduct()}" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                        <% int count = 0; %>
                                        <c:forEach items="${listProducts.getProductDetails()}" var="listProductsImage">
                                            ...
                                            <div class="grid-img">
                                                <img src="<c:url value="/resources/images/${listProductsImage.getImage().getPath()}"/>"
                                                     class="img-responsive" alt="${listProductsImage.getImage().getPath()}">
                                            </div>
                                        </c:forEach>
                                    </a>
                                </figure>
