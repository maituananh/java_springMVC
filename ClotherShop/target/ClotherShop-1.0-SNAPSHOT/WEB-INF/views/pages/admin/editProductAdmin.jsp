                    ...
                    <div class="card-body card-block">
                        <form method="post" class="form-horizontal main-form">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col col-md-4">
                                    <select name="select" class="form-control disabled">
                                        ...
                                        <c:forEach items="${producerList}" var="producerLists">
                                            <c:if test="${producerLists.getIdProducer() != infoProductDetails.getProducer().getIdProducer()}">
                                                <option value="${producerLists.getIdProducer()}">
                                                        ${producerLists.getNameProducer()}
                                                </option>
                                            </c:if>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="col col-md-4">
                                    <select name="select" class="form-control" disabled>
                                        <option value="${infoProductDetails.getUser().getIdUser()}">${infoProductDetails.getUser().getName()}</option>
                                    </select>
                                </div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-4"><input type="button" value="EDIT"
                                                                 class="form-control btn btn-info edit-main"></div>
                                <div class="col col-md-4"><input type="button" value="DELETE"
                                                                 class="form-control btn btn-danger deleteProduct-main">
                                </div>
                                <div class="col col-md-4"><input type="button" value="ADD"
                                                                 class="form-control btn btn-primary addProduct-main">
                                </div>
                            </div>
                        </form>
                    </div>
                                            ...
                                            <div class="col col-md-12">
                                                <div class="col col-md-6" style="float: left">
                                                    <img style="float: left"
                                                         class="avatar-${productDetails.getIdProductDetails()}"
                                                ...
                                                <div class="col col-md-6 input-right" style="float: left">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="file" name="image"
                                                               id="file-${productDetails.getIdProductDetails()}"
...
<%--                <div class="col-lg-12" id="add" style="display: none">--%>
<%--                    <div class="card">--%>
<%--                        <div class="card-header">--%>
...
<%--                                          id="formId">--%>
<%--                                        <div style="display: none">--%>
<%--                                            <input value="" id="idDetailProduct">--%>
<%--                                        </div>--%>
<%--                                        <div class="row form-group">--%>
<%--                                            <div class="col col-md-12">--%>
<%--                                                <div class="col col-md-6" style="float: left">--%>
